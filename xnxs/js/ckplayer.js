...
function ckplayerConfig() {
	return {
		...
		menu: { //版权名称支持
			ckkey: 'ckplayer91a5f5ff4770050812ee9389ff5a3dfe',
		    name: '中业版权所有',
		    link: 'http://www.zhongye.net',
		    version: 'v0.1',
			domain: '',
			more: []
		},
		...
		*/
		getVideo: function() {
			...
			if (this.html5Video) { //如果支持HTML5-VIDEO则默认使用HTML5-VIDEO播放器
				...
				var mobileautofull = '';
				if (!mobileAutoFull) {
					mobileautofull = ' x-webkit-airplay="true" playsinline  webkit-playsinline="true"  x5-playsinline"';//清除属性 x5-video-player-type="h5" 播放就不会全屏了
				}
